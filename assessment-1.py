...
# # 4. Write a Python program that takes two numbers as input and print their sum (use variables)
a = int (input("Enter the first number: "))
b = int (input ("Enter the second number: "))
sum = a + b
print(sum)

# # 5. Create a Python progran that accepts two number from a user and calculates the multiplication (use variables).
a = 5
b = 6
result = 5 * 6
print(result)
